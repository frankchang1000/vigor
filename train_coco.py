...
def train_net(net,
              ...
              dir='runs/12_30_all/',
              p_clean=0.3,
              data_path="full_dataset/all/data"):
    ...
    val_loader_clean = DataLoader(val_clean, batch_size=1, shuffle=False, num_workers=1, pin_memory=True, drop_last=True)
    ...
    val_loader_adv = DataLoader(val_adv, batch_size=1, shuffle=False, num_workers=1, pin_memory=True, drop_last=True)
    ...
    for epoch in range(epochs):
        ...
        with tqdm(total=n_train, desc=f'Epoch {epoch + 1}/{epochs}', unit='img') as pbar:
            for imgs, true_masks in train_loader:
                ...
                global_step += 1
                print("global_step calc: ", global_step)
                print("n_train: ", n_train)
...
def get_args():
    ...
    parser.add_argument('-r', '--p_clean', dest='p_clean', type=float, default=0.2,
    ...
    parser.add_argument('--data_path', type=str, default="full_dataset/all/data/")
    #parser.add_argument('--data_path', type=str, default="full_dataset/apricot/data/")
    #parser.add_argument('--data_path', type=str, default="adv_data/data/")
    parser.add_argument('-dir', '--dir', dest='dir', default='runs/12_31_all/', type=str, help='dir for saving files')
